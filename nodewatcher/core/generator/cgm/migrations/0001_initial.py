    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('platform', nodewatcher.core.registry.fields.RegistryChoiceField('node.config', 'core.general#platform', max_length=50, blank=True)),
                ('router', nodewatcher.core.registry.fields.RegistryChoiceField('node.config', 'core.general#router', max_length=50, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('routing_announces', nodewatcher.core.registry.fields.RegistryMultipleChoiceField(blank=True, default=[], regpoint='node.config', null=True, verbose_name='Announce Via', enum_id='core.interfaces.network#routing_announce', size=None)),
                ('lease_type', nodewatcher.core.registry.fields.RegistryChoiceField('node.config', 'core.interfaces.network#lease_type', blank=True, max_length=50, null=True, verbose_name='Lease Type', choices=[('dhcp', 'DHCP')])),
                ('lease_duration', models.DurationField()),
                ('nat_type', nodewatcher.core.registry.fields.RegistryChoiceField('node.config', 'core.interfaces.network#nat_type', blank=True, max_length=50, null=True, verbose_name='NAT Type', choices=[('snat-routed-networks', 'SNAT (towards routed networks)')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('interfaceconfig_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to='cgm.InterfaceConfig')),
                ('routing_protocols', nodewatcher.core.registry.fields.RegistryMultipleChoiceField(blank=True, default=[], null=True, regpoint='node.config', enum_id='core.interfaces#routing_protocol', size=None)),
                ('eth_port', nodewatcher.core.registry.fields.RegistryChoiceField('node.config', 'core.interfaces#eth_port', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('interfaceconfig_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to='cgm.InterfaceConfig')),
                ('service', nodewatcher.core.registry.fields.RegistryChoiceField('node.config', 'core.interfaces#mobile_service', default='umts', max_length=50, choices=[('umts', 'UMTS'), ('gprs', 'GPRS'), ('cdma', 'CDMA')])),
                ('device', nodewatcher.core.registry.fields.RegistryChoiceField('node.config', 'core.interfaces#mobile_device', default='mobile0', max_length=50, choices=[('mobile0', 'Mobile0'), ('mobile1', 'Mobile1')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('limit_out', nodewatcher.core.registry.fields.RegistryChoiceField('node.config', 'core.interfaces.limits#speeds', default='', max_length=50, verbose_name='Limit OUT', blank=True, choices=[('128', '128 Kbit/s'), ('256', '256 Kbit/s'), ('512', '512 Kbit/s'), ('1024', '1 Mbit/s'), ('2048', '2 Mbit/s'), ('4096', '4 Mbit/s')])),
                ('limit_in', nodewatcher.core.registry.fields.RegistryChoiceField('node.config', 'core.interfaces.limits#speeds', default='', max_length=50, verbose_name='Limit IN', blank=True, choices=[('128', '128 Kbit/s'), ('256', '256 Kbit/s'), ('512', '512 Kbit/s'), ('1024', '1 Mbit/s'), ('2048', '2 Mbit/s'), ('4096', '4 Mbit/s')])),
            ],
            options={
                'ordering': ['id'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('interfaceconfig_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to='cgm.InterfaceConfig')),
                ('routing_protocols', nodewatcher.core.registry.fields.RegistryMultipleChoiceField(blank=True, default=[], null=True, regpoint='node.config', enum_id='core.interfaces#routing_protocol', size=None)),
                ('mode', nodewatcher.core.registry.fields.RegistryChoiceField('node.config', 'core.interfaces#wifi_mode', max_length=50, choices=[('mesh', 'Mesh'), ('ap', 'AP'), ('sta', 'STA')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('interfaceconfig_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to='cgm.InterfaceConfig')),
                ('wifi_radio', nodewatcher.core.registry.fields.RegistryChoiceField('node.config', 'core.interfaces#wifi_radio', max_length=50)),
