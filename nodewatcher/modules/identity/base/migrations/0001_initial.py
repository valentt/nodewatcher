    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trust_policy', nodewatcher.core.registry.fields.RegistryChoiceField('node.config', 'core.identity#trust_policy', default='first', max_length=50, choices=[('any', 'Trust any identity (INSECURE)'), ('first', 'Trust and store the first received identity'), ('config', 'Only trust explicitly configured identities')])),
