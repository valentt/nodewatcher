    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profiles', nodewatcher.core.registry.fields.RegistryMultipleChoiceField(help_text='Selected network profiles affect how the node is configured when automatic defaults are enabled. In case defaults are disabled, selecting network profiles will have no effect.', blank=True, default=[], null=True, regpoint='node.config', enum_id='network.profile#profiles', size=None)),
