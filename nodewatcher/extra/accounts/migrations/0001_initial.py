    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', nodewatcher.extra.accounts.fields.LanguageField(default=nodewatcher.extra.accounts.fields.get_initial_language, help_text='Choose the language you wish this site to be in.', max_length=5, choices=[('en', 'English'), ('sl', 'Slovenian')])),
                ('attribution', models.CharField(default='name', help_text='What to use when we want to give you public attribution for your participation and contribution?', max_length=8, verbose_name='attribution', choices=[('name', 'Use my full name'), ('username', 'Use my username'), ('nothing', 'Hide me')])),
