...
class Command(base.BaseCommand):
    option_list = base.BaseCommand.option_list + (
        ...
        optparse.make_option(
            ...
            help="Stream types given as comma-separated values of 'int', 'float', 'enum', or 'graph' (default: int). Domain can be specified in parenthesis (defaults: %s)" % ", ".join(["%s(%s)" % (name, d) for name, (type, f, d) in TYPES.items()]),
        ),
        optparse.make_option(
